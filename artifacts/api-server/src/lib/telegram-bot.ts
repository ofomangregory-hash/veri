...
export function startTelegramBot(): TelegramBot | null {
  ...
  // Polling runs in all environments by default.
  // To disable: set DISABLE_TELEGRAM_BOT=true (already set on Replit dev server).
  // Railway single-instance deployments poll fine; no extra flag needed.
